...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: "Geral", href: "/indicadores" },
      { label: "APR Digital", href: "/indicadores/apr" },
      { label: "Controle de Frota", href: "/indicadores/frota" },
      { label: "Indisponibilidade (Turmas)", href: "/indicadores/indisponibilidade" },
      { label: "Logística CCM", href: "/indicadores/logccm" },
      { label: "Produtividade CCM", href: "/indicadores/produtividade" },
      { label: "Produtividade Turmas", href: "/indicadores/turmas" },
      { label: "Rejeições", href: "/indicadores/rejeicoes" },
      { label: "Saída de Base CCM", href: "/indicadores/saida-base" },
      { label: "SESMT 05S", href: "/indicadores/5s" },
      { label: "Turmas RDO", href: "/indicadores/turmas/rdo" },
    ],
  },
]
