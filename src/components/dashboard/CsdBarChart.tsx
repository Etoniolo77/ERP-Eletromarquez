...
import { Bar, BarChart, ResponsiveContainer, XAxis, YAxis, Tooltip, CartesianGrid, ReferenceLine, Cell } from "recharts"
...
export function CsdBarChart({ data, meta, onBarClick, selectedBar, unit = "%", variant = 'status' }: CsdBarChartProps) {
    ...
    const minWidth = data.length > 10 ? data.length * 40 : '100%'
                        ...
                        >
                            ...
                            >
                                {data.map((entry, index) => {
                                    ...
                                    // Inverted logic for time metrics (unit='min')
